...
void	Bureaucrat::signForm(AForm *form)
{
	...
	catch (const Bureaucrat::FormIsNull& e)
    {
        std::cout << _name << " can't sign because " << e.what() << std::endl;
    }
}
...
void	Bureaucrat::executeForm(AForm const *form)
{
    ...
    {
        std::cout << _name << " can't execute because " << e.what() << std::endl;
    }
}
...
const char* Bureaucrat::FormIsNull::what() const throw() { return "Form doesn't exist."; }
